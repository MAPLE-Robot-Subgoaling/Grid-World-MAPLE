...
=======
		nodes.get(1).neighbors.put(nodes.get(2), 12.4);
		nodes.get(1).neighbors.put(nodes.get(4), 3.5);
		nodes.get(2).neighbors.put(nodes.get(1), 3.4);
		nodes.get(2).neighbors.put(nodes.get(5), 2.4);
		nodes.get(3).neighbors.put(nodes.get(0), 1.0);
		nodes.get(3).neighbors.put(nodes.get(4), 1.5);
		nodes.get(3).neighbors.put(nodes.get(6), 0.9);
		nodes.get(4).neighbors.put(nodes.get(1), 1.4);
		nodes.get(4).neighbors.put(nodes.get(3),4.5);
		nodes.get(4).neighbors.put(nodes.get(5), 5.6);
		nodes.get(4).neighbors.put(nodes.get(7), 5.6);
		nodes.get(5).neighbors.put(nodes.get(2), 5.6);
		nodes.get(5).neighbors.put(nodes.get(4), 4.5);
		nodes.get(5).neighbors.put(nodes.get(8), 7.8);
		nodes.get(6).neighbors.put(nodes.get(3), 0.9);
		nodes.get(6).neighbors.put(nodes.get(7), 0.8);
		nodes.get(7).neighbors.put(nodes.get(4), 4.5);
		nodes.get(7).neighbors.put(nodes.get(6), 0.8);
		nodes.get(7).neighbors.put(nodes.get(8), 0.7);
		nodes.get(8).neighbors.put(nodes.get(5), 6.7);
>>>>>>> af21dd630e9f7d449e1d5b9ba7fb1cb990142152
...
>>>>>>> af21dd630e9f7d449e1d5b9ba7fb1cb990142152
	 ...
	 * 		returns -3 if agent location was not identified
	 */
...
=======
		...
		//goes through the list to find the index of the 
		for(int i = 0; i < nodes.size(); i++){
			if(nodes.get(i).isHere()){
				index = i;
			}
